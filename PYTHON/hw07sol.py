...
print('bellsAAnFrequency: ' + str(litCricFriend(['a','an'],theBells)))
print('bellsTheFrequency: ' + str(litCricFriend(['the'],theBells)))
print('cantoAAnFrequency: ' + str(litCricFriend(['a','an'],cantoXII)))
print('cantoAAnFrequency: ' + str(litCricFriend(['the'],cantoXII)))
...
# differently?
'''
bellsAAnFrequency: 0.0347682119205298
bellsTheFrequency: 0.1357615894039735
cantoAAnFrequency: 0.009615384615384616
cantoAAnFrequency: 0.05448717948717949

The result show that they use 'a','an' and'the' differently.
'''
'''
